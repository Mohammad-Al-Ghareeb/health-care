  ...
  return (
    <div className=" bg-white rounded-lg shadow">
      <div className="p-[24px] flex items-center justify-between border-b border-b-[#0000001a]">
        <h6 className="font-[700] text-[#000000]">PRESCRIPTIONS LIST</h6>
      </div>
        ...
        <table className="min-w-full border-collapse  ">
          <thead>
            <tr className="bg-[#009efb] text-white">
              ...
              <th className="p-[0.75rem] text-start">Medication</th>
              <th className="p-[0.75rem] text-start">Period Of medication</th>
