...
import { getAllAmbulances } from "../redux/apiCalls/AmbulanceApiCall";
...
const AmbulancesPage = () => {
  ...
  const focusStyle = isFocused
    ...
    : {};
  const { ambulances, documentCount } = useSelector((state) => state.ambulance);
